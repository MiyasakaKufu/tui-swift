...
final class Base64Tests: XCTestCase {
    ...
    func testPaddingFollowsRemainingByteCount() {
    ...
    func testEncodedLengthIsAlwaysAMultipleOfFour() {
        for count in 0..<32 {
